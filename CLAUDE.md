...
**Open threads (priority order):** (1) Calibration + abstention — turn momval composite ranks into confidence; abstain when the cross-section is weak. (2) Robustness — WF gate grades the beta path; re-grade per-fold beta-neutral. Done: right-tail variant → momval book SHIPPED (2026-06-08); 52w-high probe → KILLED (2026-06-10). Live forward-paper review ~2026-08-27. Pre-2016 breadth needs a Polygon tier upgrade.
